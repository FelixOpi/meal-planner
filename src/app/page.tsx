...
const ProfileModal = ({ isOpen, onClose, preferences, onUpdatePreferences }: ProfileModalProps) => (
  <Transition appear show={isOpen} as={Fragment}>
    <Dialog as="div" className="relative z-50" onClose={onClose}>
      ...
      <div className="fixed inset-0 overflow-y-auto">
        <div className="flex min-h-full items-center justify-center sm:p-4 p-2">
          <Dialog.Panel className="w-full max-w-lg transform overflow-hidden rounded-2xl bg-white shadow-xl transition-all mx-auto">
            {/* Header */}
            <div className="p-4 sm:p-6 border-b">
              <Dialog.Title as="h3" className="text-lg sm:text-xl font-semibold text-gray-900 pr-8">
